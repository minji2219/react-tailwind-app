    ...
    <section name="home" className='flex w-full  h-screen bg-zinc-200'>
      <div className='grid md:grid-cols-2 max-w-[1240px] m-auto' >
        ...
        <div className='flex flex-col justify-center px-2'>
          <h2 className='font-semibold xs:text-[48px] text-[40px] xs:leading-[76.8px] leading-[66.8px] w-full'>Easiliy download app <br className='hidden sm:block'/>Google & Apple</h2>
