      ...
      <div className='flex items-center justify-between w-full h-full px-10'>
        <div className='flex items-center'>
          ...
          <ul className='hidden md:flex'>
            ...
            <li><Link to='support' duration={500} smooth={true}>Support</Link></li>
            <li><Link to='feature' duration={500} smooth={true}>Feature</Link></li>
            <li><Link to='testimonials' duration={500} smooth={true}>Feedback</Link></li>
          </ul>
        </div>
